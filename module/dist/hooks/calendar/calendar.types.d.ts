...
export interface IDay {
    /** The date object representing the day in question */
    date: Date;
    /** The day number in context of it's month, like "30th" June. */
    numberInMonth: number;
    /** The 0-6 index of the days position within the week. Sunday = 0, Saturday = 6. */
    indexInWeek: number;
    /** Is this the currently selected day within the calendar view? */
    isSelected: boolean;
    /** Is this day currently disabled within the calendar view? */
    isDisabled: boolean;
    /** Is this day the same as today based on the locale? */
    isToday: boolean;
    /** Has this day been highlighted with a dot? */
    isHighlighted: boolean;
    /** Optional class name for highlighted status marker */
    highlightedClassName?: string;
    /** Is this date at the beginning of a two date range? */
    isRangeStart: boolean;
    /** Is this date at the end of a two date range? */
    isRangeEnd: boolean;
    /** Is this date in between the two dates in a two date range? */
    isRangeMiddle: boolean;
}
/** Defines the data required by the calendar view and associated with a single month  */
export interface IMonth {
    /** The date object representing the month in question */
    date: Date;
    /** The 0-11 index of the months position within the year. January = 0, December = 11. */
    indexInYear: number;
    /** Is this month currently disabled within the calendar view? */
    isDisabled: boolean;
}
/** Defines the data required by the calendar view and associated with a single month  */
export interface IYear {
    /** The date object representing the year in question */
    date: Date;
    /** The year as a 4 digit number number (e.g 2021) */
    number: number;
}
...
export interface IConfig {
    /** The currently selected date as a string or a `Date` object. Will default to today. */
    selectedDate?: Dates.DateLike;
    /** An optional minimum selectable date. If passed, all dates before this date will not be selectable. */
    min?: Dates.DateLike;
    /** An optional maximum selectable date. If passed, all dates after this date will not be selectable. */
    max?: Dates.DateLike;
    /**
     * An optional date to display a range to.
    ...
    /**
     * A formatter to apply when displaying the day selector on the input.
     * - Must be a date-fns compliant format token (see [docs](https://date-fns.org/v2.0.0-alpha.7/docs/format))
    ...
    /**
     * A formatter to apply when displaying the month selector on the input.
     * - Must be a date-fns compliant format token (see [docs](https://date-fns.org/v2.0.0-alpha.7/docs/format))
    ...
    /**
     * A formatter to apply when displaying the year selector on the input.
     * - Must be a date-fns compliant format token (see [docs](https://date-fns.org/v2.0.0-alpha.7/docs/format))
