 ...
 */
export declare function useEventListener(type: string, eventHandler: (e: Event) => any, element?: Pick<HTMLElement, 'addEventListener' | 'removeEventListener'> | undefined, options?: boolean | AddEventListenerOptions | undefined): void;
