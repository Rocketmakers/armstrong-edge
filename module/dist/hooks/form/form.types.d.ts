 ...
 */
export declare type KeyOrIndex<TData, TDataKey extends keyof TData> = TData extends object ? Extract<TDataKey, TData extends any[] ? number : unknown> : never;
/**
 ...
 */
export declare type BindingTools<TValue> = TValue extends any[] ? BindingToolsArray<TValue> : BindingToolsStandard<TValue>;
/**
...
export declare abstract class FormPropFactory<TData extends object> {
     ...
     */
    formProp<TDataKey extends keyof Required<TData>>(...args: [key1: KeyOrIndex<Required<TData>, TDataKey>]): BindingTools<Required<TData>[TDataKey]>;
    /**
     * Used to access a property within the form data.
     * @param args The keys or indexes used to access a nested property to a depth of 2.
     */
    formProp<TDataKey extends keyof Required<TData>, TData2 extends Required<TData>[TDataKey], TDataKey2 extends keyof TData2>(...args: [key1: KeyOrIndex<Required<TData>, TDataKey>, key2: KeyOrIndex<TData2, TDataKey2>]): BindingTools<TData2[TDataKey2]>;
    /**
     * Used to access a property within the form data.
     * @param args The keys or indexes used to access a nested property to a depth of 3.
     */
    formProp<TDataKey extends keyof Required<TData>, TData2 extends Required<TData>[TDataKey], TDataKey2 extends keyof TData2, TData3 extends TData2[TDataKey2], TDataKey3 extends keyof TData3>(...args: [key1: KeyOrIndex<Required<TData>, TDataKey>, key2: KeyOrIndex<TData2, TDataKey2>, key3: KeyOrIndex<TData3, TDataKey3>]): BindingTools<TData3[TDataKey3]>;
    /**
     * Used to access a property within the form data.
     * @param args The keys or indexes used to access a nested property to a depth of 4.
     */
    formProp<TDataKey extends keyof Required<TData>, TData2 extends Required<TData>[TDataKey], TDataKey2 extends keyof TData2, TData3 extends TData2[TDataKey2], TDataKey3 extends keyof TData3, TData4 extends TData3[TDataKey3], TDataKey4 extends keyof TData4>(...args: [
 ...
 */
export declare type KeyChain = Array<PropertyKey>;
/**
 ...
 */
export declare type FormDispatcher<TData> = (action: FormAction<TData, any>) => TData;
/**
 ...
 */
export declare type FormValidationMode = 'icon' | 'message' | 'both';
/**
 ...
 */
export declare type FormAction<TData, TValue> = IFormSetOneAction<TValue> | IFormSetPathAction<TValue> | IFormSetAllAction<TData>;
/**
...
export declare type ValidationAction = IAddValidationAction | IClearValidationAction;
