...
exports.Button = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("button", tslib_1.__assign({}, nativeProps, { className: classNames_1.ClassNames.concat('arm-button', className, { 'arm-button-minimal': minimalStyle }), "data-pending": pending, "data-disabled": disabled || pending, "data-error": shouldShowErrorIcon, disabled: disabled || pending, ref: ref, tabIndex: disabled ? -1 : nativeProps === null || nativeProps === void 0 ? void 0 : nativeProps.tabIndex }),
