 ...
 * @param externalRef - An external ref used to pass the dialog controls out of the component using this hook
...
export const useDialog = <TData>(
  externalRef?: React.Ref<DialogElement<TData>>
  ...
  React.useImperativeHandle(externalRef, () => dialogRef.current as DialogElement<TData>);
