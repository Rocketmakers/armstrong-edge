...
const CodeInputPart = <TBind extends NullOrUndefined<string>>(props: ICodeInputPartProps<TBind> & { ref?: React.Ref<HTMLInputElement> }) => {
  const { bind, part, ref, ...inputProps } = props;
...
export const CodeInput = <TBind extends NullOrUndefined<string>>(props: ICodeInputProps<TBind> & { ref?: React.Ref<HTMLDivElement> }) => {
  const {
    className,
    parts,
    bind,
