...
// import { AutoCompleteMultiInput } from './autoCompleteMultiInput.component';

// /** metadata */

// export default StoryUtils.createMeta(AutoCompleteMultiInput, 'Form', 'Auto Complete Input', {
//   placeholder: {
//     control: { type: 'text' },
...
// const Template = StoryUtils.createTemplate(AutoCompleteMultiInput);
