...
export const Default: StoryObj<typeof Icon> = {
  ...
  play: async ({ args, canvasElement }) => {
    ...
    expect(canvas.getByTitle('Icon')).toHaveAttribute('data-icon-set', args.iconSet);
...
export const IcomoonOnly: StoryObj<typeof IcomoonIcon> = {
  ...
  play: async ({ args, canvasElement }) => {
    const canvas = within(canvasElement);
    expect(canvas.getByTitle('Icon')).toHaveAttribute('data-icon-set', 'Icomoon');
    expect(canvas.getByTitle('Icon')).toHaveAttribute('data-i', args.icon);
  }
};
...
export const LinearIconOnly: StoryObj<typeof LinearIcon> = {
  ...
  play: async ({ args, canvasElement }) => {
    const canvas = within(canvasElement);
    expect(canvas.getByTitle('Icon')).toHaveAttribute('data-icon-set', 'LinearIcons');
    expect(canvas.getByTitle('Icon')).toHaveAttribute('data-i', args.icon);
  }
};