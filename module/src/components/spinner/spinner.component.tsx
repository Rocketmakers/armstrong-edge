...
export const Spinner = (props: React.PropsWithChildren<ISpinnerProps & { ref?: React.Ref<HTMLDivElement> }>) => {
  const { children, className, icon, fillContainer, label, ref, ...HTMLProps } = props;
