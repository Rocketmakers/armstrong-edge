...
export interface ITextAreaInputProps extends NativeTextAreaProps, IInputWrapperProps {
  ...
  (
    ...
    return (
      ...
      >
        ...
        {!delay?.milliseconds && <textarea {...nativeProps} {...inputProps} onChange={onChangeEvent} ref={ref} />}
      </InputWrapper>
    );
  }
);
