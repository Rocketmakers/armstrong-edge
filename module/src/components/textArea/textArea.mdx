...
```tsx
import { TextArea } from '@rocketmakers/armstrong';
...
- [Basic TextArea example](#basic)
- [Label and placeholder example](#label-placeholder)
...
### <a name="basic">Basic TextArea example</a>
...
```tsx
<TextArea label="Please write below" placeholder="Placeholder content 🚀" required />
```
