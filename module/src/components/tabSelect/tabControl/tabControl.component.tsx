...
export interface ITabControlTabPropsCore<Id extends ArmstrongId>
  extends ITab<Id> {
...
export const TabControlTab = React.forwardRef(
  ...
  props: React.PropsWithRef<ITabControlTabProps<Id>> &
    React.RefAttributes<HTMLButtonElement>
) => ReturnType<React.FC>) & {
  defaultProps?: Partial<ITabControlTabProps<any>>;
};

export interface ITabControlWrapperProps
  extends Omit<React.HTMLAttributes<HTMLDivElement>, "ref"> {}

export const TabControlWrapper = React.forwardRef<
  HTMLDivElement,
  React.PropsWithChildren<ITabControlWrapperProps>
...
export interface ITabControlProps<Id extends ArmstrongId>
  extends Omit<React.HTMLAttributes<HTMLDivElement>, "ref"> {
...
export const TabControl = React.forwardRef(
  ...
  props: ArmstrongFCProps<ITabControlProps<Id>, HTMLDivElement>
) => ArmstrongFCReturn) &
