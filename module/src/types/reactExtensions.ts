...
export type ArmstrongFCProps<TProps, TRef> = React.PropsWithChildren<TProps> &
  React.RefAttributes<TRef | undefined>;
export type ArmstrongVFCProps<TProps, TRef> = TProps &
  React.RefAttributes<TRef | undefined>;
