...
/**
 * Context passed to validation message formatter callbacks.
 */
export interface IValidationMessageFormatterInput {
  /** The raw Zod issue */
  issue: z.core.$ZodIssue;
  /** The key path for the invalid field in dot notation */
  key: string;
  /** The default message generated by Zod */
  defaultMessage: string;
}

/**
 * Optional callback to format validation messages generated from Zod issues.
 */
export type ValidationMessageFormatter = (
  input: IValidationMessageFormatterInput
...
export interface IFormConfig<TData> {
  ...
  /**
   * Optional callback to transform Zod issue messages before they are dispatched to field errors.
   * - If omitted, Armstrong will use the default Zod issue message.
   */
