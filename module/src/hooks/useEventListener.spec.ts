...
describe('useEventListener', () => {
  ...
  it('should remove event listener when component unmounts', () => {
    ...
    const { unmount } = renderHook(() => useEventListener(eventType, eventHandler, elementMock));

    unmount();

    expect(removeEventListenerMock).toHaveBeenCalledWith(eventType, eventHandler, {});
  });
