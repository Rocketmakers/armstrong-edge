 ...
 */
export declare function useBoundingClientRect(ref: React.MutableRefObject<Element | undefined | null>, onChange?: (newBoundingClientRect: DOMRect) => void, listenToScroll?: boolean): UseBoundingClientRectReturn;
