import{j as o}from"./jsx-runtime-Cl2eCCBe.js";import{c as D,f as H,w as x,e as n,u as h,a as T}from"./classNames-TtGgGdEV.js";import{r as d}from"./index-Cqyox1Tj.js";import{a as Ue}from"./useDidUpdateEffect-CQd39TVK.js";import{a as $e,f as Ge,u as A,L as Je}from"./label.component-BjYIJ-30.js";import{S as Qe}from"./statusWrapper.component-DCIbvlN0.js";import{I as G}from"./input.component-DsxJNSxD.js";import{u as Xe}from"./config.context-DSGy4VcJ.js";import{V as Ye}from"./validationErrors.component-CrXQH9ID.js";import"./extends-CF3RwP-h.js";import"./index-QqxU7g3h.js";import"./index-DGXSSr1l.js";import"./spinner.component-GjtI7h28.js";import"./inputWrapper.component-BPs1nEnr.js";import"./radixDialog-CBrwtQa5.js";function V(r){return typeof r=="number"?r:typeof r=="string"?0:r.length}const ve=d.forwardRef(({bind:r,part:e,...l},u)=>{const t=d.useMemo(()=>V(e),[e]);if(typeof e=="string")return o.jsx("p",{className:"arm-code-input-part-text",children:e});if(typeof e=="number")return o.jsx(G,{ref:u,bind:r,...l,className:"arm-code-input-part-input",style:{"--arm-code-input-length":t},"data-length":t,onClick:y=>y.currentTarget.select(),maxLength:e});const{className:w,...f}=e;return o.jsx(G,{ref:u,bind:r,className:D("arm-code-input-part-input",w),style:{...f.style||{},"--arm-code-input-length":t},"data-length":t,onClick:y=>y.currentTarget.select(),...l,...f,maxLength:e.length,displaySize:e.displaySize})});ve.displayName="CodeInputPart";const b=d.forwardRef(({className:r,parts:e,bind:l,onChange:u,validationMode:t,validationErrorMessages:w,errorIcon:f,error:y,value:S,pending:I,statusPosition:he,leftOverlay:L,rightOverlay:_,scrollValidationErrorsIntoView:xe,displaySize:ye,label:W,required:fe,requiredIndicator:be,hideIconOnStatus:we,statusClassName:Ve,validationErrorsClassName:Te,labelClassName:Ce,labelId:Ee,disableOnPending:He,disabled:Be,autoValidate:Se,...Ie},je)=>{var U;const j=d.useRef([]),[g,C,c]=$e(l,{onChange:u,validationErrorMessages:w,validationMode:t,value:S,autoValidate:Se}),p=Xe({validationMode:c.validationMode,inputStatusPosition:he,inputDisplaySize:ye,requiredIndicator:be,hideInputErrorIconOnStatus:we,disableControlOnPending:He,scrollValidationErrorsIntoView:xe,validationErrorIcon:f,autoValidate:c.autoValidate}),P=d.useCallback(s=>{var i;const a=e.slice(s+1).findIndex(m=>typeof m!="string")+s+1;a!==-1&&((i=j.current[a])==null||i.focus())},[e]),N=d.useCallback(s=>{var i;const a=Ge(e.slice(0,s),m=>typeof m!="string");a!==-1&&((i=j.current[a])==null||i.focus())},[e]),K=d.useCallback((s,a)=>{const i=e.slice(0,s).reduce((k,z)=>k+V(z),0),m=i+V(e[s]);return(a==null?void 0:a.slice(i,m))||""},[e]),Pe=d.useCallback((s,a)=>{const i=V(e[a]);(s.currentTarget.value||"").length>=i&&P(a)},[e,P]),ke=d.useCallback(s=>{s.preventDefault();const a=s.clipboardData.getData("text/plain"),i=s.target,m=j.current.indexOf(i),k=Math.min(i.selectionStart??0,i.selectionEnd??0),z=Math.max(i.selectionStart??0,i.selectionEnd??0),$=new Array(m).fill(null).reduce((_e,Ze,We)=>{const Ke=e[We];return _e+V(Ke)},0)+k,ze=$+(z-k),De=(g==null?void 0:g.slice(0,$))??"",Ae=(g==null?void 0:g.slice(ze))??"",Le=De+a+Ae;C(Le)},[C,g,e]),Re=d.useMemo(()=>e.map((s,a)=>K(a,g)),[K,e,g]),Oe=d.useCallback((s,a,i)=>{var m;switch(s.key){case"Backspace":{((m=s.currentTarget.value)==null?void 0:m.length)<=0&&a>0&&N(a);break}case"ArrowLeft":{s.currentTarget.selectionStart===0&&a>0&&N(a);break}case"ArrowRight":{s.currentTarget.selectionEnd===V(i)&&a<e.length&&P(a);break}}},[N,P,e]),{formProp:qe,formState:v}=A({parts:Re});d.useEffect(()=>{var s;C==null||C((s=v==null?void 0:v.parts)==null?void 0:s.join(""))},[v]),Ue(()=>{p.autoValidate&&c.isTouched&&c.validate()},[g]);const Fe=d.useCallback(()=>{v!=null&&v.parts.every(s=>s)&&p.autoValidate&&!c.isTouched&&(c.validate(),c.setTouched(!0))},[c,v==null?void 0:v.parts,p.autoValidate]),Me=L&&(p.inputStatusPosition!=="left"||!p.hideInputErrorIconOnStatus||!I&&(!c.shouldShowValidationErrorIcon||!c.validationErrorMessages.length)),Ne=_&&(p.inputStatusPosition!=="right"||!p.hideInputErrorIconOnStatus||!I&&(!c.shouldShowValidationErrorIcon||!c.validationErrorMessages.length));return o.jsxs(o.Fragment,{children:[o.jsxs("div",{ref:je,title:"Code input",...Ie,children:[W&&o.jsx(Je,{className:D("arm-code-input-label",Ce),id:Ee,required:fe,requiredIndicator:p.requiredIndicator,displaySize:p.inputDisplaySize,children:W}),o.jsx("div",{className:D("arm-code-input",r),children:o.jsx(Qe,{error:y||!!c.validationErrorMessages.length,errorIcon:c.validationErrorIcon,statusPosition:p.inputStatusPosition,pending:I,validationMode:c.validationMode,className:Ve,children:o.jsxs(o.Fragment,{children:[Me&&L,e==null?void 0:e.map((s,a)=>o.jsx(ve,{type:"text",bind:qe("parts",a).bind(),part:s,onChange:i=>Pe(i,a),onKeyDown:i=>Oe(i,a,+s),onPaste:ke,onBlur:Fe,disabled:Be||I&&p.disableControlOnPending,ref:i=>{j.current[a]=i},displaySize:p.inputDisplaySize},a)),Ne&&_]})})})]}),!!((U=c.validationErrorMessages)!=null&&U.length)&&c.shouldShowValidationErrorMessage&&o.jsx(Ye,{className:Te,validationErrors:c.validationErrorMessages,scrollIntoView:p.scrollValidationErrorsIntoView})]})});b.displayName="Code Input";b.__docgenInfo={description:"",methods:[],displayName:"Code Input",props:{bind:{required:!1,tsType:{name:"IBindingProps",elements:[{name:"TBind"}],raw:"IBindingProps<TBind>"},description:"Prop for binding to an Armstrong form binder (see forms documentation)"},value:{required:!1,tsType:{name:"TBind"},description:"The current value of the input"},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(newValue: TBind) => void",signature:{arguments:[{type:{name:"TBind"},name:"newValue"}],return:{name:"void"}}},description:"Fired when the code input changes"},parts:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:"ICodeInputInput<TBind> | string | number",elements:[{name:"ICodeInputInput",elements:[{name:"TBind"}],raw:"ICodeInputInput<TBind>"},{name:"string"},{name:"number"}]}],raw:"CodeInputPartDefinition<TBind>[]"},description:`The parts of the code input
...
}`,...(X=(Q=E.parameters)==null?void 0:Q.docs)==null?void 0:X.source},description:{story:"stories",...(Z=(Y=E.parameters)==null?void 0:Y.docs)==null?void 0:Z.description}}};var ee,te,ne;R.parameters={...R.parameters,docs:{...(ee=R.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: args => {
    interface IFormData {
...
}`,...(pe=(ue=F.parameters)==null?void 0:ue.docs)==null?void 0:pe.source}}};var de,me,ge;M.parameters={...M.parameters,docs:{...(de=M.parameters)==null?void 0:de.docs,source:{originalSource:`{
  ...Template,
  args: {
    onChange: fn(),
    parts: [1, {
...
}`,...(ge=(me=M.parameters)==null?void 0:me.docs)==null?void 0:ge.source}}};const ht=["Default","Sizes","ValidationError","DifferentLengths","WithTextBetween","WithOverlays"];export{E as Default,q as DifferentLengths,R as Sizes,O as ValidationError,M as WithOverlays,F as WithTextBetween,ht as __namedExportsOrder,vt as default};
