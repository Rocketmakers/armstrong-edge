import{j as e}from"./jsx-runtime-Cl2eCCBe.js";import{c as B,f as U,w as v,u as p,a as b,e as i}from"./classNames-TtGgGdEV.js";import{u as de,c as me}from"./config.context-DSGy4VcJ.js";import{r as S}from"./index-Cqyox1Tj.js";import{a as ue}from"./useDidUpdateEffect-CbsfOrtL.js";import{C as pe}from"./checkbox.component-l-N9FXN_.js";import{g as be}from"./options-Q_-Fwsn7.js";import{a as he,L as ve,u as ge}from"./label.component-Cg6sDyTB.js";import{V as xe}from"./validationErrors.component-CrXQH9ID.js";import"./extends-CF3RwP-h.js";import"./index-CcyUcsxs.js";import"./index-QqxU7g3h.js";import"./index-DGXSSr1l.js";import"./statusWrapper.component-DCIbvlN0.js";import"./spinner.component-GjtI7h28.js";const d=S.forwardRef(({bind:t,options:n,className:a,value:r,errorIcon:o,validationMode:C,validationErrorMessages:m,onChange:$,customIndicator:K,error:Q,displaySize:W,label:A,labelClassName:Y,labelId:Z,required:ee,disabled:q,scrollValidationErrorsIntoView:ae,validationErrorsClassName:ne,requiredIndicator:te,autoValidate:re,...ie},oe)=>{const[s,g,l]=he(t,{value:r,validationErrorMessages:m,validationErrorIcon:o,validationMode:C,onChange:$,autoValidate:re}),u=de({validationMode:l.validationMode,requiredIndicator:te,scrollValidationErrorsIntoView:ae,validationErrorIcon:l.validationErrorIcon,inputDisplaySize:W,autoValidate:l.autoValidate}),se=S.useCallback((c,h)=>{const E=n.reduce((le,T)=>{const z=T.id===c.id,ce=(s==null?void 0:s.includes(T.id))?!z||h:z&&h;return[...le,...ce?[T.id]:[]]},[]);g==null||g(E)},[g,s,n]);return ue(()=>{u.autoValidate&&l.validate(),l.setTouched(!0)},[s]),e.jsxs(e.Fragment,{children:[A&&e.jsx(ve,{id:Z,className:B("arm-checkbox-list-label",Y),required:ee,requiredIndicator:u.requiredIndicator,displaySize:u.inputDisplaySize,children:A}),e.jsxs("div",{className:B("arm-checkbox-list",a),ref:oe,"data-error":Q||!!(m!=null&&m.length),"data-disabled":q,"data-size":u.inputDisplaySize,...ie,children:[n.map(c=>{const h=s==null?void 0:s.includes(c.id);return S.createElement(pe,{customIndicator:K,...c.htmlProps??{},key:c.id,className:"arm-checkbox-list-item",checked:h,displaySize:u.inputDisplaySize,onCheckedChange:E=>se(c,E),disabled:q||c.disabled,label:be(c,h)})}),l.shouldShowValidationErrorMessage&&l.validationErrorMessages&&e.jsx(xe,{validationErrors:l.validationErrorMessages,scrollIntoView:u.scrollValidationErrorsIntoView,className:B("arm-checkbox-list-errors",ne)})]})]})});d.displayName="CheckboxList";d.__docgenInfo={description:"Render a list of radio inputs which binds to a single string",methods:[],displayName:"CheckboxList",props:{bind:{required:!1,tsType:{name:"IBindingProps",elements:[{name:"Array",elements:[{name:"Id"}],raw:"Id[]"}],raw:"IBindingProps<Id[]>"},description:"prop for binding to an Armstrong form binder (see forms documentation)"},options:{required:!0,tsType:{name:"Array",elements:[{name:"IArmstrongOption",elements:[{name:"Id"},{name:"Omit",elements:[{name:"ICheckboxProps",elements:[{name:"boolean"}],raw:"ICheckboxProps<boolean>"},{name:"union",raw:`| 'bind'
| 'checked'
| 'disabled'
| 'label'
