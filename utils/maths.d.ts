...
export declare function clamp(input: number, minimum: number, maximum: number): number;
/**
 ...
 */
export declare function positiveModulo(numerator: number, denominator: number): number;
/**
 * Get a value as a percent of another value
 */
export declare function getPercent(value: number, total: number): number;
/** lerp between two numbers based on a progress */
export declare function lerp(start: number, end: number, /** out of 100 */ progress: number): number;
/** lerp between multiple numbers, with equally spaced breakpoints */
export declare function multiLerp(breakpoints: number[], progress: number): number;
