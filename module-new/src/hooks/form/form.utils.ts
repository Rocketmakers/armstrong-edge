...
import { InitialDataFunction, IValidationError, KeyChain } from './form.types';
...
export function valueByKeyChain<TData, TValue>(state: TData, keyChain: KeyChain): TValue | undefined {
  return keyChain.reduce((value, key) => value?.[key], state) as TValue | undefined;
}
