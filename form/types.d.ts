...
import { type ZodArray, type ZodBigInt, type ZodBoolean, type ZodDate, type ZodEffects, type ZodLiteral, type ZodNullable, type ZodNumber, type ZodObject, type ZodOptional, type ZodRawShape, type ZodString, type ZodTypeAny, type ZodUnion } from 'zod';
/**
...
type WithZodAdditions<T extends ZodTypeAny, K> = T | ZodLiteral<K> | ZodOptional<T> | ZodNullable<T> | ZodOptional<ZodNullable<T>> | ZodEffects<T, K, K> | ZodUnion<[WithZodAdditions<T, K>, ...ZodTypeAny[]]>;
/**
