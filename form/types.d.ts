...
import { type ZodArray, type ZodBigInt, type ZodBoolean, type ZodDate, type ZodEffects, type ZodEnum, type ZodLiteral, type ZodNativeEnum, type ZodNullable, type ZodNumber, type ZodObject, type ZodOptional, type ZodRawShape, type ZodString, type ZodTypeAny, type ZodUnion } from 'zod';
/**
 ...
 */
export type KeyOrIndex<TData, TDataKey extends keyof TData> = TData extends object ? Extract<TDataKey, TData extends unknown[] ? number : unknown> : never;
/**
 ...
 */
type StringType<T> = [any extends T ? 'true' : 'false'] extends ['true'] ? 'any' : T extends boolean ? 'boolean' : T extends Array<unknown> ? 'array' : T extends string ? 'string' : T extends bigint ? 'bigint' : T extends number ? 'number' : T extends Date ? 'date' : T extends object ? 'object' : 'rest';
/**
...
export interface IFormProp<TData extends object> {
     ...
     */
    <TDataKey extends keyof Required<TData>>(...args: [key1: KeyOrIndex<Required<TData>, TDataKey>]): BindingTools<Required<TData>[TDataKey]>;
    /**
     * Used to access a property within the form data.
     * @param args The keys or indexes used to access a nested property to a depth of 2.
     */
    <TDataKey extends keyof Required<TData>, TData2 extends Required<TData>[TDataKey], TDataKey2 extends keyof TData2>(...args: [key1: KeyOrIndex<Required<TData>, TDataKey>, key2: KeyOrIndex<TData2, TDataKey2>]): BindingTools<TData2[TDataKey2]>;
    /**
     * Used to access a property within the form data.
     * @param args The keys or indexes used to access a nested property to a depth of 3.
     */
    <TDataKey extends keyof Required<TData>, TData2 extends Required<TData>[TDataKey], TDataKey2 extends keyof TData2, TData3 extends TData2[TDataKey2], TDataKey3 extends keyof TData3>(...args: [
     ...
     */
    <TDataKey extends keyof Required<TData>, TData2 extends Required<TData>[TDataKey], TDataKey2 extends keyof TData2, TData3 extends TData2[TDataKey2], TDataKey3 extends keyof TData3, TData4 extends TData3[TDataKey3], TDataKey4 extends keyof TData4>(...args: [
        key1: KeyOrIndex<Required<TData>, TDataKey>,
        key2: KeyOrIndex<TData2, TDataKey2>,
        key3: KeyOrIndex<TData3, TDataKey3>,
     ...
     */
    <TDataKey extends keyof Required<TData>, TData2 extends Required<TData>[TDataKey], TDataKey2 extends keyof TData2, TData3 extends TData2[TDataKey2], TDataKey3 extends keyof TData3, TData4 extends TData3[TDataKey3], TDataKey4 extends keyof TData4, TData5 extends TData4[TDataKey4], TDataKey5 extends keyof TData5>(...args: [
        key1: KeyOrIndex<Required<TData>, TDataKey>,
        key2: KeyOrIndex<TData2, TDataKey2>,
        key3: KeyOrIndex<TData3, TDataKey3>,
        key4: KeyOrIndex<TData4, TDataKey4>,
 ...
 */
export type ZodNullOrUndefined<TProp, TZod extends ZodTypeAny> = TProp extends undefined ? ZodOptional<TZod> : TProp extends null ? ZodNullable<TZod> : TZod;
/**
...
export interface IArrayOfZod<TProp> {
    ...
    opts?: (arr: ZodArray<TProp & ZodTypeAny>) => ZodArray<TProp & ZodTypeAny> | ZodNullable<ZodTypeAny> | ZodOptional<ZodTypeAny> | ZodOptional<ZodNullable<ZodTypeAny>> | ZodEffects<ZodTypeAny>;
}
/**
...
export interface IObjectOfZod<TProp> {
    ...
    opts?: (ob: ZodObject<TProp & ZodRawShape>) => ZodObject<TProp & ZodRawShape> | ZodNullable<ZodTypeAny> | ZodOptional<ZodTypeAny> | ZodOptional<ZodNullable<ZodTypeAny>> | ZodEffects<ZodTypeAny>;
}
type WithZodAdditions<T extends ZodTypeAny, K> = T | ZodLiteral<K> | ZodOptional<T> | ZodNullable<T> | ZodOptional<ZodNullable<T>> | ZodEffects<T, K, K> | ZodUnion<[WithZodAdditions<T, K>, ...ZodTypeAny[]]> | ZodNativeEnum<any> | ZodEnum<any>;
/**
 ...
 */
export type IValidationSchema<TData> = TData extends Array<infer U> ? IArrayOfZod<U> : TData extends object ? {
 ...
 * - Zod prefer you to generate the type from the runtime validation schema, but because we're working from a generated TS client, we need this type so we can do things the other way around
 */
export type IRootValidationSchema<TData> = TData extends Array<infer U> ? IArrayOfZod<U> : TData extends object ? {
    [K in keyof TData]: ToZod<TData[K]>;
} | IObjectOfZod<{
    [K in keyof TData]: ToZod<TData[K]>;
}> : never;
