...
export interface ICodeInputInput<TBind extends NullOrUndefined<string>> extends Omit<ITextInputProps<TBind>, 'onChange' | 'value' | 'delay' | 'onValueChange' | 'validationErrorMessages' | 'validationMode' | 'ref' | 'maxLength' | 'onKeyDown' | 'bind'> {
